<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <ProductDetail-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/mall/product/listProductDetailByMainId",
          delete: "/mall/product/deleteProductDetail",
          deleteBatch: "/mall/product/deleteBatchProductDetail",
        }
      }
    },
    methods: {
      ...
      handleAdd: function () {
        ...
        this.$refs.modalForm.title = "添加商品详细信息";
      },
    }
  }
</script>
