  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/mall/product/listCollectionByMainId",
          delete: "/mall/product/deleteCollection",
          deleteBatch: "/mall/product/deleteBatchCollection",
        }
      }
    },
    methods: {
      ...
      handleAdd: function () {
        ...
        this.$refs.modalForm.title = "添加收藏信息";
      },
    }
  }
</script>
