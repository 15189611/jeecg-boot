<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <Trace-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/crm/customer/listTraceByMainId",
          delete: "/crm/customer/deleteTrace",
          deleteBatch: "/crm/customer/deleteBatchTrace",
        }
      }
    },
    methods: {
      ...
      handleAdd: function () {
        ...
        this.$refs.modalForm.title = "添加跟进信息";
      },
    }
  }
</script>
