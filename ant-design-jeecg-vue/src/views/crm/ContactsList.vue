<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <Contacts-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/crm/customer/listContactsByMainId",
          delete: "/crm/customer/deleteContacts",
          deleteBatch: "/crm/customer/deleteBatchContacts",
        }
      }
    },
    methods: {
