...
public class AreaController {
	 ...
	 * @return
	 */
	@AutoLog(value = "区域信息-分页列表查询")
	@ApiOperation(value="区域信息-分页列表查询", notes="区域信息-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "区域信息-添加")
	@ApiOperation(value="区域信息-添加", notes="区域信息-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "区域信息-编辑")
	@ApiOperation(value="区域信息-编辑", notes="区域信息-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "区域信息-通过id删除")
	@ApiOperation(value="区域信息-通过id删除", notes="区域信息-通过id删除")
	@DeleteMapping(value = "/delete")
	public Result<Area> delete(@RequestParam(name="id",required=true) String id) {
		Result<Area> result = new Result<Area>();
		Area area = areaService.getById(id);
		if(area==null) {
			result.error500("未找到对应实体");
		}else {
			boolean ok = areaService.removeById(id);
			if(ok) {
				result.success("删除成功!");
			}
		}
	 ...
	 * @return
	 */
	@AutoLog(value = "区域信息-批量删除")
	@ApiOperation(value="区域信息-批量删除", notes="区域信息-批量删除")
  ...
  public ModelAndView exportXls(HttpServletRequest request, HttpServletResponse response) {
      ...
      //导出文件名称
      mv.addObject(NormalExcelConstants.FILE_NAME, "区域信息列表");
      mv.addObject(NormalExcelConstants.CLASS, Area.class);
      mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("区域信息列表数据", "导出人:Jeecg", "导出信息"));
  ...
  public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
      ...
      for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
          ...
          try {
              ...
              for (Area areaExcel : listAreas) {
                  areaService.save(areaExcel);
              }
