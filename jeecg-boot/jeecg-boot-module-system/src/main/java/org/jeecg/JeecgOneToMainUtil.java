...
//		po2.setTableName("t_shop_user_detail");		//表名
//		po2.setEntityName("UserDetail");			//实体名
//		po2.setEntityPackage("mall"); 				//包名
//		po2.setFtlDescription("详细信息");			//描述
//		//子表外键参数配置
//		/*说明:
//		 * a) 子表引用主表主键ID作为外键，外键字段必须以_ID结尾;
//		 * b) 主表和子表的外键字段名字，必须相同（除主键ID外）;
//		 * c) 多个外键字段，采用逗号分隔;
//		 */
//		po2.setForeignKeys(new String[]{"user_Id"});
//		subTables.add(po2);
